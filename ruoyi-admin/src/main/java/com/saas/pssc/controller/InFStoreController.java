        ...
        for (InFStore inFStore : inFStoreList)
        {
            try
            {
                ...
                if (!lossFlag)
                {
                    ...
                    successNum++;
                    successMsg.append("<br/>" + successNum + "、成品库存记录 " +inStore.getMname()+ " 导入成功");
                }
                else if (isUpdateSupport)
                {
                    ...
                    successNum++;
                    successMsg.append("<br/>" + successNum + "、成品库存记录 " +inStore.getMname() + " 更新成功");
                }
                else
                {
                    failureNum++;
                    failureMsg.append("<br/>" + failureNum + "、成品库存记录 " +inStore.getMname() + " 已存在");
                }
            }
            catch (Exception e)
            {
                failureNum++;
                String msg = "<br/>" + failureNum + "、成品库存记录 " + inFStore.getMname()+ " 导入失败：";
