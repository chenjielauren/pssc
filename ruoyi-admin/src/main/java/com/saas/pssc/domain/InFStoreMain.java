 ...
 * @date 2021-07-22
 */
public class InFStoreMain extends BaseEntity
{
    ...
    /** 库存明细信息 */
    private List<InFStoreDetail> inStoreDetailList;

    /** 材料库存明细信息 */
    private List<InFStoreDetail> inMStoreDetailList;

    /** 半成品库存明细信息 */
    private List<InFStoreDetail> inSfStoreDetailList;

    /** 成品库存明细信息 */
    private List<InFStoreDetail> inFStoreDetailList;
    ...
    public List<InFStoreDetail> getInStoreDetailList()
    {
        return inStoreDetailList;
    }

    public void setInStoreDetailList(List<InFStoreDetail> inStoreDetailList)
    {
        this.inStoreDetailList = inStoreDetailList;
    }

    
    public List<InFStoreDetail> getInMStoreDetailList() {
        return inMStoreDetailList;
    }

    public void setInMStoreDetailList(List<InFStoreDetail> inMStoreDetailList) {
        this.inMStoreDetailList = inMStoreDetailList;
    }

    public List<InFStoreDetail> getInSfStoreDetailList() {
        return inSfStoreDetailList;
    }

    public void setInSfStoreDetailList(List<InFStoreDetail> inSfStoreDetailList) {
        this.inSfStoreDetailList = inSfStoreDetailList;
    }

    public List<InFStoreDetail> getInFStoreDetailList() {
        return inFStoreDetailList;
    }

    public void setInFStoreDetailList(List<InFStoreDetail> inFStoreDetailList) {
