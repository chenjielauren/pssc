 ...
 * @date 2021-07-22
 */
public class InSfStoreMain extends BaseEntity
{
    ...
    /** 库存明细信息 */
    private List<InSfStoreDetail> inStoreDetailList;

    /** 材料库存明细信息 */
    private List<InSfStoreDetail> inMStoreDetailList;

    /** 半成品库存明细信息 */
    private List<InSfStoreDetail> inSfStoreDetailList;

    /** 成品库存明细信息 */
    private List<InSfStoreDetail> inFStoreDetailList;
    ...
    public List<InSfStoreDetail> getInStoreDetailList()
    {
        return inStoreDetailList;
    }

    public void setInStoreDetailList(List<InSfStoreDetail> inStoreDetailList)
    {
        this.inStoreDetailList = inStoreDetailList;
    }

    
    public List<InSfStoreDetail> getInMStoreDetailList() {
        return inMStoreDetailList;
    }

    public void setInMStoreDetailList(List<InSfStoreDetail> inMStoreDetailList) {
        this.inMStoreDetailList = inMStoreDetailList;
    }

    public List<InSfStoreDetail> getInSfStoreDetailList() {
        return inSfStoreDetailList;
    }

    public void setInSfStoreDetailList(List<InSfStoreDetail> inSfStoreDetailList) {
        this.inSfStoreDetailList = inSfStoreDetailList;
    }

    public List<InSfStoreDetail> getInFStoreDetailList() {
        return inFStoreDetailList;
    }

    public void setInFStoreDetailList(List<InSfStoreDetail> inFStoreDetailList) {
