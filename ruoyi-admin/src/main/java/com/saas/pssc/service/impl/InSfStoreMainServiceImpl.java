...
import com.saas.pssc.mapper.InSfStoreMainMapper;
 ...
 */
@Service
public class InSfStoreMainServiceImpl implements IInSfStoreMainService 
{
    @Autowired
    private InSfStoreMainMapper inStoreMainMapper;
     ...
     */
    public void insertInStoreDetail(InSfStoreMain inStoreMain)
    {
        List<InSfStoreDetail> inStoreDetailList = inStoreMain.getInStoreDetailList();
        Long id = inStoreMain.getId();
        if (StringUtils.isNotNull(inStoreDetailList))
        {
            List<InSfStoreDetail> list = new ArrayList<InSfStoreDetail>();
            for (InSfStoreDetail inStoreDetail : inStoreDetailList)
            {
