...
insert into sys_menu values('4', '标准信息', '0', '4', '#',                '',          'M', '0', '1', '', 'fa fa-bars',           'admin', sysdate(), '', null, '系统工具目录');
insert into sys_menu values('5', '库存信息', '0', '5', '#',                '',          'M', '0', '1', '', 'fa fa-bar-chart',           'admin', sysdate(), '', null, '系统工具目录');
insert into sys_menu values('6', '订单信息', '0', '6', '#',                '',          'M', '0', '1', '', 'fa fa-shopping-basket',    'admin', sysdate(), '', null, '系统工具目录');
insert into sys_menu values('7', '生产信息', '0', '7', '#',                '',          'M', '0', '1', '', 'fa fa-bookmark',           'admin', sysdate(), '', null, '系统工具目录');
insert into sys_menu values('8', '质量信息', '0', '8', '#',                '',          'M', '0', '1', '', 'fa fa-binoculars',           'admin', sysdate(), '', null, '系统工具目录');
